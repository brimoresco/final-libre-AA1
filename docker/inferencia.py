...
#with open("model/modelRGD.joblib", "rb") as f:
 #   model = joblib.load(f)
#with open("model/scaler.joblib", "rb") as f:
 #   scaler = joblib.load(f)
#with open("model/imputer.joblib", "rb") as f:
 #   imputer = joblib.load(f)
#with open("model/modelRLOG.joblib", "rb") as f:
 #   imputer = joblib.load(f)
#with open("model/median_values.joblib", "rb") as f:
 #   imputer = joblib.load(f)
#with open("model/mode_values.joblib", "rb") as f:
 #   imputer = joblib.load(f)
